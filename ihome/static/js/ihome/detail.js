...
$(document).ready(function () {
    ...
    $.get("/api/v1_0/houses/" + houseId, function (resp) {
        if (resp.error_code == 0) {
            $(".swiper-container").html(template("house-image-tmp", {img_urls: resp.data.house.img_urls, price:resp.data.house.price}));
            $(".detail-con").html(template("house-detail-tmp", {house: resp.data.house}));
